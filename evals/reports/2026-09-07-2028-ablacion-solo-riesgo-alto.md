# Ablación · sólo la definición de `riesgo_alto`

- Modelo: `gpt-5.5-2026-04-23` · fecha de corte `2026-06-01`
- 2 preguntas × 1 corridas = 2 llamadas
- Costo: US$ 0.26 · 31,667 tokens de entrada y 3,338 de salida
- Latencia: p50 19.6 s · p95 16.4 s
...
|---|---|---|---|---|
| `c-002` | umbral_versionado_por_institucion | banco_andino | 0/1 | estado `NO_SE_PUEDE_RESPONDER`, esperaba RESPONDIDA o RESPONDIDA_CON_SUPUESTO |
